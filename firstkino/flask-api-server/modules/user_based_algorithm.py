...
def naversee_surprise(userscore2, userId, movie_data):
...
def recommend_movie(algo, userId, naver_seen_movie, movie_data, top_n=20):
    predictions = []
    ...
    for pred in top_pred:
        ...
        result.append({ "title": movie_title, "rating": movie_rating})
